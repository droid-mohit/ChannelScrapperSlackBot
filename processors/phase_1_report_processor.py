...
def source_identifier(full_message_cell):
    ...
    container_keywords = ['Prometheus', 'ComponentOutOfMemory', 'HostHighCpuLoad', 'KubeDeploymentReplicasMismatch',
                          'KubePodNotReady', 'HostOomKillDetected', 'ContainerCPUUsage', 'HostCpuHighIowait',
                          'HostUnusualDiskWriteRate', 'HostUnusualDiskReadRate', 'ThanosQueryGrpcClientErrorRate',
                          'KubePersistentVolumeFillingUp', 'KubePodCrashLooping', 'BlackboxProbeFailed',
                          'BlackboxProbeHttpFailure', 'BlackboxSlowProbe', 'NodeUnschedulable',
                          'KubeDaemonSetMisScheduled', 'KubeNodeNotReady', 'KubeNodeUnreachable', 'TargetDown',
                          'KubeContainerWaiting', 'KubeDaemonSetRolloutStuck', 'KubeHpaMaxedOut',
                          'KubeControllerManagerDown', 'KubeNodeReadinessFlapping', 'ElasticsearchNotHealthy',
