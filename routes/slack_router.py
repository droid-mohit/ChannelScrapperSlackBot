...
def install():
    ...
    return redirect(
        f'https://slack.com/oauth/v2/authorize?client_id={SLACK_CLIENT_ID}&scope=channels:read,chat:write,chat:write.public,commands&redirect_uri={SLACK_REDIRECT_URI}&state={state}')
